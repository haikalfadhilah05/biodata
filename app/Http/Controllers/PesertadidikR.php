...
class PesertadidikR extends Controller
{
    ...
    public function index()
    {
        ...
        $pesertaM = PesertadidikM::search(request('search'))->paginate(5);
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('pesertadidik.index')->with('success', 'Peserta Didik Berhasil Ditambah');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('pesertadidik.index')->with('success', 'Peserta Didik Berhasil Diedit');
    }
